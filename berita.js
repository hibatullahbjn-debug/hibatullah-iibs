...
(function () {
  ...
  function makeCard(item, idx) {
    ...
    return '<a href="artikel.html?id=' + (item.wp_id || idx) + '" class="kegiatan-card" data-idx="' + idx + '">' +
      ...
      '<div class="kegiatan-body">' +
        '<div class="kegiatan-date"><i class="far fa-calendar-alt"></i> ' + tgl + '</div>' +
        ...
        '<div class="kegiatan-footer">' +
          '<div class="kegiatan-author">' +
            ...
            '<div><span class="author-name">' + esc(item.author || 'Admin') + '</span><span class="author-role">Penulis</span></div>' +
          '</div>' +
  ...
  function openModal(item) {
    ...
    document.getElementById('btModalAuthor').textContent = item.author || 'Admin';
