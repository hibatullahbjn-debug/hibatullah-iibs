...
=========================== */
/* FOR PORTRAIT TABLETS & MOBILES (matches the tall screenshot) */
@media (max-width: 1200px) and (orientation: portrait), (max-width: 900px) {
  ...
  .hero-bg-wrap {
    ...
    /* FIX THE STRETCHING: Cover proportionally */
    background-size: cover !important; 
    background-position: center 10% !important; /* Keep top/center in view */
  }
  ...
  /* Dark overlay from bottom to top for text readability */
  .hero-bg-color {
    display: block !important;
    position: absolute !important;
    inset: 0 !important;
...
css = css.replace(regex, finalIpadFix);
fs.writeFileSync('style.css', css);
console.log('Applied final proportional layout fix');
